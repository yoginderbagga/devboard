    ...
    <div className="relative max-w-6xl mx-auto px-6 py-8 space-y-7">
      ...
      <header className="flex items-end justify-between gap-4 db-rise">
        <div>
          ...
          <h1 className="text-[30px] font-semibold leading-none tracking-[-0.6px]">Good to see you, Yoginder Bagga Updated with Pipeline is LIVE NOW TODAY AT  8th August 2026</h1>
